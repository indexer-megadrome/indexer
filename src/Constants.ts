...
export const monad = {
  ...
  rpcUrls: {
    default: { http: ["https://monad.rpc.hypersync.xyz"] },
    public: { http: ["https://monad.rpc.hypersync.xyz"] },
  },
...
export const DefaultRPC = {
  ...
  monad: "https://monad.rpc.hypersync.xyz",
} as const;
...
// Constants for Monad
const MONAD_CONSTANTS: chainConstants = {
  weth: "0x3bd359C1119dA7Da1D913D1C4D2B7c461115433A", // WMON (Verified from previous search)
  usdc: "0x0000000000000000000000000000000000000000", // TODO: Add USDC Address
  oracle: {
    getType: (blockNumber: number) => {
      return PriceOracleType.V2; // Using V2 as default/safe bet
    },
    getAddress: (priceOracleType: PriceOracleType) => {
      // Placeholder - Assuming standard V2 deployment layout or needing update
      return "0x0000000000000000000000000000000000000000";
    },
    startBlock: 0,
    updateDelta: 60 * 60, // 1 hour
    priceConnectors: [], // No connectors yet
  },
  rewardToken: (blockNumber: number) =>
    "0x01452d1e3F10E9Eda4335f9244Ba096871AA8c10", // MEGA
  newCLGaugeFactoryAddress: "",
  eth_client: createPublicClient({
    chain: monad,
    transport: http(process.env.ENVIO_MONAD_RPC_URL || DefaultRPC.monad, {
      batch: true,
      timeout: RPC_TIMEOUT_MS,
    }),
  }),
  lpHelperAddress: "0x0000000000000000000000000000000000000000", // Placeholder
};
